...
public class Formation {
    ...
    public Formation(Long id, String libelle, String numeroOffre, Date dateDebut, Date dateFin,
                     Date dateDebutPe, Date dateFinPe, Boolean statut) {
        this.id = id;
    ...
    // Getters & Setters (tu peux les générer auto dans ton IDE si tu veux)
    ...
    public Date getDateDebutPe() { return dateDebutPe; }
    public void setDateDebutPe(Date dateDebutPe) { this.dateDebutPe = dateDebutPe; }

    public Date getDateFinPe() { return dateFinPe; }
    public void setDateFinPe(Date dateFinPe) { this.dateFinPe = dateFinPe; }
    ...
    public List<FormationDocument> getFormationDocuments() { return formationDocuments; }
    public void setFormationDocuments(List<FormationDocument> formationDocuments) { this.formationDocuments = formationDocuments; }

    public List<FormationRessource> getFormationRessources() { return formationRessources; }
    public void setFormationRessources(List<FormationRessource> formationRessources) { this.formationRessources = formationRessources; }
}
